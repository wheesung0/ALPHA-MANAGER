...
source <(curl -sL https://raw.githubusercontent.com/wheesung0/ALPHA-MANAGER/master/Install/V2RAY/install-v2ray.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/wheesung0/ALPHA-MANAGER/master/Install/V2RAY/install-v2ray.sh) --remove > /dev/null 2>&1
