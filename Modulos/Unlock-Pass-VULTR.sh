...
wget https://raw.githubusercontent.com/wheesung0/ALPHA-MANAGER/master/Install/ArchivosUtilitarios/common-password -O /etc/pam.d/common-password > /dev/null 2>&1
