...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/wheesung0/ALPHA-MANAGER/master/Install/ArchivosUtilitarios/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
